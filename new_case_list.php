...
<body>
<h4 style="color:red"> รอดำเนินการ || รายการแจ้งซ่อมใหม่ </h4>
 <table width="100%" border="1" cellspacing="0" class="display" id="example">
  ...
  <?php do { ?>
    <tr>
      <td align="center">
      <a href="new_case_detail.php?pd_number=<?php echo $row_newsca['pd_number']; ?>" target="_blank" class="btn btn-primary btn-sm">
      รับงาน</a></td>
      <td align="center"><?php echo $row_newsca['pd_number']; ?></td>
      <td>
	  <font color="blue">
	  <?php  //  ID :อุปกรณ์ :  echo $row_newsca['der_id']; ?>
      </font>
